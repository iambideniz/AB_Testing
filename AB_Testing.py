...
# Dataset Story:
# In this dataset, which includes the website information of XXXXXXXXXXX.com, there is information such as the number of advertisements that users see and click and earnings information from here.
